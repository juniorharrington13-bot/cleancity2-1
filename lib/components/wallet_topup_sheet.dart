...
class _WalletTopupSheetState extends State<WalletTopupSheet> {
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      final msg = raw.contains('wallet_topups') || raw.contains('relation')
          ? context.l10n.walletTopupUnavailable
    ...
    return Padding(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(context.l10n.walletTopupSheetTitle, style: context.textStyles.titleLarge?.copyWith(fontWeight: FontWeight.bold)),
          const SizedBox(height: 6),
          Text(context.l10n.walletTopupSheetSubtitle, style: context.textStyles.bodySmall?.copyWith(color: LightModeColors.lightOnSurfaceVariant)),
          const SizedBox(height: 14),
          Form(
            key: _formKey,
            child: Column(
